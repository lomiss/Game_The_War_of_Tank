...
public class CustomNetworkRoomManager : NetworkManager
{
    ...
    public CustomNetworkRoomPlayer roomPlayerPrefab;
    ...
    public List<CustomNetworkRoomPlayer> roomSlots = new List<CustomNetworkRoomPlayer>();
    ...
    public void ReadyStatusChanged()
    {
        ...
        foreach (CustomNetworkRoomPlayer item in roomSlots)
        {
            if (item != null)
            {
                CurrentPlayers++;
    ...
    public override void OnServerReady(NetworkConnection conn)
    {
        ...
        if (conn != null && conn.identity != null)
        {
            ...
            if (roomPlayer != null && roomPlayer.GetComponent<CustomNetworkRoomPlayer>() != null)
    ...
    void SceneLoadedForPlayer(NetworkConnection conn, GameObject roomPlayer)
    {
        ...
        if (gamePlayer == null)
        {
            ...
            gamePlayer = Instantiate(playerPrefab, startPos, Quaternion.identity);
            Player p = gamePlayer.transform.GetComponent<Player>();
            p.teamIndex = teamIndex;
            GameManager.GetInstance().size[teamIndex]++;
            GameManager.GetInstance().ui.OnTeamSizeChanged(SyncList<int>.Operation.OP_SET,teamIndex,0,0);
        }
    ...
    public void CheckReadyToBegin()
    {
        ...
        int numberOfReadyPlayers = NetworkServer.connections.Count(conn => conn.Value != null && conn.Value.identity.gameObject.GetComponent<CustomNetworkRoomPlayer>().readyToBegin);
    ...
    public override void OnServerDisconnect(NetworkConnection conn)
    {
        if (conn.identity != null)
        {
            ...
            {
                roomPlayer = clientOwnedObject.GetComponent<CustomNetworkRoomPlayer>();
                if (roomPlayer != null)
                    roomSlots.Remove(roomPlayer);
            }
        }
        ...
        {
            if (player != null)
                player.GetComponent<CustomNetworkRoomPlayer>().readyToBegin = false;
        }
    ...
    public override void ServerChangeScene(string newSceneName)
    {
        ...
        {
            foreach (CustomNetworkRoomPlayer roomPlayer in roomSlots)
            {
                if (roomPlayer == null)
                    continue;
                ...
                if (NetworkServer.active)
                {
                    ...
                    roomPlayer.GetComponent<CustomNetworkRoomPlayer>().readyToBegin = false;
